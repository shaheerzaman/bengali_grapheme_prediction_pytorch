...
export MODEL_STD='(0.224, 0.225, 0.229)'
export BASE_MODEL='resnet34'

export TRAINING_FOLD='(0, 1, 2, 3)'
export VALIDATION_FOLDS='(4,)'
python train.py

export TRAINING_FOLD='(1, 2, 3, 4)'
export VALIDATION_FOLDS='(0)'
python train.py

export TRAINING_FOLD='(0, 4, 2, 3)'
export VALIDATION_FOLDS='(1,)'
python train.py

export TRAINING_FOLD='(0, 1, 4, 3)'
export VALIDATION_FOLDS='(2,)'
python train.py

export TRAINING_FOLD='(0, 1, 4, 2)'
